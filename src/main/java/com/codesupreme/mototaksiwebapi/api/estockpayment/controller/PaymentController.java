package com.codesupreme.mototaksiwebapi.api.estockpayment.controller;

import com.codesupreme.mototaksiwebapi.model.payment.PaymentRequest;
...
@RestController
@RequestMapping("/api/v6/estock")
public class PaymentController {

    private static final String PRIVATE_KEY = "7K3uAuxTiV55Huc08tNVq4Gn";
    private static final String PUBLIC_KEY = "i000201035";
